...
# إنشاء متغير نافذة لفتح ملف
dial = QFileDialog.getOpenFileName(window, "Open File", "/home")  # (مسار فى لينكس , اسم النافذة , النافذة الأم)
#dial = QFileDialog.getOpenFileName(window, "Open File", "c:\'")  # (مسار فى ويندوز , اسم النافذة , النافذة الأم)
print(dial)
